...
@ActiveProfiles("test")
@TestPropertySource(properties = "onboarding.highAvailabilityMode=false")
public class FileStorageServiceImplNonHAmodeTest {
    ...
    public void testDeleteFileFromObjectStorage() {
        ...
        verify(objectStorageService, never()).deleteFile(filePath);
    }
    @Test
    public void testStoreFileWithObjectStorage() throws IOException, URISyntaxException {
        ...
        verify(objectStorageService, never()).uploadFile(any(File.class), any(String.class));
