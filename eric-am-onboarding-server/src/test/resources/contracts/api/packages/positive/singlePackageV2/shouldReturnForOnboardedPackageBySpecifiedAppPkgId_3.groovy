...
""")
    request{
        method GET()
        url "/api/v2/packages/${value(consumer("d3def1ce-4cf4-477c-aab3-21cb04e6a382"),producer("d3def1ce-4cf4-477c-aab3-21cb04e6a382"))}"
    }
    response {
        status OK()
        headers {
        ...
        body(file("packageDetailsSpecific3.json"))
