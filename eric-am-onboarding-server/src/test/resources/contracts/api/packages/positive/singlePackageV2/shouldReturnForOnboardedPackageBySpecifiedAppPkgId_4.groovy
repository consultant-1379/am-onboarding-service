...
""")
    request{
        method GET()
        url "/api/v2/packages/${value(consumer("d3def1ce-4cf4-477c-aab3-21cb04e6a383"),producer("d3def1ce-4cf4-477c-aab3-21cb04e6a383"))}"
    }
    response {
        status OK()
        headers {
        ...
        body(file("packageDetailsSpecific4.json"))
