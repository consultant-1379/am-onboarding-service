...
""")
    request{
        method GET()
        url "/api/v1/packages/${value(consumer("d3def1ce-4cf4-477c-aab3-21cb04e6a386"),producer("d3def1ce-4cf4-477c-aab3-21cb04e6a386"))}"
    }
    response {
        status OK()
        headers {
        ...
        body(file("packageDetailsSpecific6.json"))
