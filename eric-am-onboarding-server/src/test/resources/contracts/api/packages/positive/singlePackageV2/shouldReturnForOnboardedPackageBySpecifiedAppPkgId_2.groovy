...
""")
    request{
        method GET()
        url "/api/v2/packages/${value(consumer("d3def1ce-4cf4-477c-aab3-21cb04e6a380"),producer("d3def1ce-4cf4-477c-aab3-21cb04e6a380"))}"
    }
    response {
        status OK()
        headers {
        ...
        body(file("packageDetailsSpecific2.json"))
