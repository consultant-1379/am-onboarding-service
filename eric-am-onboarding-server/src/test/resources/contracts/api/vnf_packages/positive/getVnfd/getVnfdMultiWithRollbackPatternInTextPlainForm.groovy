...
""")
    request{
        method GET()
        url "/api/vnfpkgm/v1/vnf_packages/multi-rollback-4cf4-477c-aab3-21cb04e6a/vnfd"
        headers {
            accept(textPlain())
        }
    }
    response {
        ...
        body(file("sample_multi_vnfd_with_rollback_at_failure_pattern.yaml.properties"))
