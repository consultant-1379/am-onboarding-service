...
""")
    request{
        method GET()
        url "/api/vnfpkgm/v1/vnf_packages/levels-no-extensions-no-scaling-mapping/vnfd"
        headers {
            accept(textPlain())
        }
    }
    response {
        ...
        body(file("sample_vnfd_with_updated_scaling_no_extensions_no_scaling_mapping.yaml.properties"))
