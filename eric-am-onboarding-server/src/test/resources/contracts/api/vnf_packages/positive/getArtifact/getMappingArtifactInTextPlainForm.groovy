...
""")
    request{
        method GET()
        url "/api/vnfpkgm/v1/vnf_packages/${value(consumer(anyNonEmptyString()))}/artifacts/Definitions/OtherTemplates/scaling_mapping.yaml"
        headers {
            accept(textPlain())
        }
    }
    response {
        ...
        body(file("scaling_mapping.yaml.properties"))
